...
test("council returns a TRADE proposal when the portfolio manager approves; usage summed over 7 calls", async () => {
  const llm = new MockLLMProvider(
    roleRouter({
      ...
      portfolio_manager:
        '{"decision":"TRADE","side":"buy","instrument":"perp","sizePct":5,"stop":201,"takeProfit":207,"expectedEdgePct":0.9,"expectedHorizonMin":120,"isBasisArb":true,"thesis":"long rNVDA vs perp"}',
    })
  );

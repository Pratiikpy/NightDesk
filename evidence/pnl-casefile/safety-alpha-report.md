...
| --- |--- |--- |
| Raw blocked-loss diagnostic |15118.9013 USDT |sum of repeated counterfactual losing intents in OOS/session study |
| Mean blocked-loss diagnostic per block |0.897957 USDT |normalizes the repeated-intent exposure |

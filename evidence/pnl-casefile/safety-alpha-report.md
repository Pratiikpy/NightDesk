...
| --- |--- |--- |
| Raw blocked-loss diagnostic |15139.4304 USDT |sum of repeated counterfactual losing intents in OOS/session study |
| Mean blocked-loss diagnostic per block |0.860635 USDT |normalizes the repeated-intent exposure |
